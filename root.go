...
//   0 — success
//   1 — general error
//   5 — contract violation (unrendered emissions; pipeline truth incomplete)
func Execute() {
	if err := rootCmd.Execute(); err != nil {
		...
		if errors.Is(err, pipeline.ErrContractViolation) {
			// Do NOT print — the Contract panel already rendered to stdout.
			os.Exit(5)
		}
